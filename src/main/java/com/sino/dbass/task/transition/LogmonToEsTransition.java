...
public class LogmonToEsTransition extends KeyedProcessFunction<Integer, String, String> {
    private static Logger LOG = Logger.getLogger(LogmonToEsTransition.class);
